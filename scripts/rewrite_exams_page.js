...
export default function Exams() {
  ...
  const openModal = (grade, practical) => {
...
fs.writeFileSync(path.join(process.cwd(), 'app', 'exams', 'page.tsx'), pageContent, 'utf8');
console.log('Successfully updated app/exams/page.tsx');
