...
const newSection = \`      {/* なぜ今、ショートカットキー検定が必要なのか？ */}
...
const startIndex = content.indexOf('{/* 試験の効果 */}');
const endIndex = content.indexOf('{/* ステップアップ */}');

if (startIndex !== -1 && endIndex !== -1) {
  content = content.substring(0, startIndex) + newSection + '\\n\\n      ' + content.substring(endIndex);
  fs.writeFileSync(filePath, content, 'utf8');
  console.log('Successfully replaced benefits section.');
} else {
