...
async function update() {
  await setDoc(doc(db, "exams", "practical-1kyu"), {
    id: "practical-1kyu", title: "1級 実務検定 (実践シミュレータ)", questionsCount: 10, passingRate: 0.6, duration: 1800, pool: p1
  });
  console.log("Updated practical-1kyu in Firestore.");
  
  await setDoc(doc(db, "exams", "practical-2kyu"), {
    id: "practical-2kyu", title: "2級 実務検定 (実践シミュレータ)", questionsCount: 10, passingRate: 0.6, duration: 1800, pool: p2
  });
